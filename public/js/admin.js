    ...
    counts.forEach((c, idx) => {
      ...
      svgHtml += `
        <div class="flex-1 flex flex-col items-center gap-1.5 group">
          ...
          <div class="w-full max-w-[36px] rounded-t-xl transition duration-500 ${isToday ? 'bg-gradient-to-t from-[#BE185D] to-[#E11D48]' : 'bg-pink-100 group-hover:bg-pink-300'}" style="height: ${Math.max(heightPercent, 12)}%;"></div>
